...
<div class="content-wrapper">
    ...
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
        <strong>Perhatian!</strong> Anda masih menggunakan kata sandi default. 
        <a href="{{ url('/dashboard/' . auth()->user()->id . '/change-password') }}" class="alert-link">Ganti Kata Sandi</a>
