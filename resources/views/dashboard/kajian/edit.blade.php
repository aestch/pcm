        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/dashboard/kajian/{{ $kajian->id }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select name="bidangkajian_id" id="bidangkajian_id" class="form-control">
                            @foreach($bidangkajians as $bidangkajian)
                                @if(old('bidangkajian_id', $kajian->bidangkajian_id) == $bidangkajian->id)
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" placeholder="Masukkan judul" value="{{ old('judul', $kajian->judul) }}" required>
                    ...
                    <div class="mb-3">
                        <input type="hidden" name="oldImage" value="{{ $kajian->image }}">
                        @if($kajian->image)
                            <img class="img-preview img-fluid mb-3 col-sm-5 d-block" src="{{ asset('storage/kajian/'. $kajian->image) }}">
                        @else
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <input id="body" type="hidden" name="body" value="{{ old('body', $kajian->body) }}">
