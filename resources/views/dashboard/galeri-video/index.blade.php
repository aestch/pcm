        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Galeri Video</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Galeri Video</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <a href="/dashboard/galeri-video/create" class="btn btn-primary btn-sm mb-3"><i class="fas fa-plus"></i> Tambah data</a>
                    ...
                    <table id="clientside" class="table table-hover table-striped table-bordered dt-responsive nowrap" style="width:100%">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                  <a href="/dashboard/galeri-video/{{ $galerivideo->id }}" class="btn btn-info btn-sm"><i class="fas fa-eye"></i> Lihat</a>
